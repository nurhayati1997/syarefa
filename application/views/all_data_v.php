          ...
          <div class="col-lg-6 col-7">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="#">Semua Data Antrian Resep</a></li>
...
<script>
  ...
  function tampilkan(){
    ...
    var baris = '<table class="table table-flush" id="tabelUser"><thead class="thead-light"><tr><th>NO</th><th>Tanggal</th><th>No Antrian</th><th>Nama</th><th>Poli</th><th>No RM</th><th>Jenis Pasien</th><th>Status</th><th>Action</th></tr></thead><tbody>'
      $.ajax({
        type:'POST',
